...
// numbers.add(5);
// numbers.add(items);
//numbers.add(items); // but these can not be  added again as it's a set and they are already there because it store the sigle memory for storing them.
...
// console.log(numbers);
// numbers.add(items);
// numbers.has(1), it is the property to check the availibility  of an item in a set;
// if(numbers.has(1)){
